...
import {faHome, faDollarSign, faFileAlt, faChartBar, faCaretRight, faClock, faCog, faQuestionCircle, faUser, faWallet} from '@fortawesome/free-solid-svg-icons';
	...
	return (
		<SidebarContainer>
			...
			<SideNavContainer >
				...
				<SidebarLink exact to="/portal/billing" icon={faDollarSign} spin>Loan Payments</SidebarLink>
				...
				<SidebarLink exact to="/portal/statements" icon={faFileAlt}>Documents</SidebarLink>
